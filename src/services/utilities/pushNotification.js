...
// import { Permissions, Notifications, WebBrowser, MailComposer } from "expo";
...
//           console.log("----val----" , val)
//           if( await AsyncStorage.getItem("expoKey" ))
//           {
...
//               }).then( async()=> {
//                 console.log("success")
//                  await AsyncStorage.setItem("expoKey" , token).then(res => {
//                      console.log("setItem done in ")
//                  })
//              var x =    await AsyncStorage.getItem("expoKey" )
