...
export class MenuOptionList extends PureComponent {
    render() {
      let { isbookmark , selectedBook,
        numberOfSelectedChapter,
        isArabic , deleteBookMark ,
        fontSizeOfText , selectedVerses,
        highlightedVerses , _retrieveData , 
        convertStringToArray , insertBookMark,
        increaseFontSize, decreaseFontSize,
        enableIsBookMark , disableIsBookMark,
        enableIsVisible , highlight ,_storeData,
        onHighlight
